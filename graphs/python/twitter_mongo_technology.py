...
class StdOutListener(StreamListener):
    ...
    def on_status(self, data):
        ...
        self.db.technology.insert({"name":data.user.name,"text":data.text,"created_at":data.created_at,"positive_score:":analysis.sentiment.p_pos*100,"negative_score:":analysis.sentiment.p_neg*100})
        return True
...
if __name__ == '__main__':
    ...
    stream.filter(languages=["en"],track=['technology','Cloud Computing','blockchain','Microsoft' , 'Apple', 'Intel','Engineering','Xiaomi','Technology 2020'])
