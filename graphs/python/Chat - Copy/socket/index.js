...
var ReportMessage = require('../bd/report').ReportMessage;
...
module.exports = function(server) {
    ...
    io.sockets.on('connection', function(socket) {
        ...
        HistoryMessage.saveMessage(username, username + " joined the chat")
        ...
        socket.on('disconnect', function() {
            HistoryMessage.saveMessage(username, username + " left the chat");
